...
myargs=()
#variable to process stat of the arguments
vvar=0
dvar=0
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  #shifting the element in the erray
  shift
...
# Print out the myargs array with a label
#cheking degug stat with if else statement
if [ $dvar -gt 0 ]; then
  echo "Debug Mode is On with debug level $dvar."
else
